           ...
           tabPanel("Interactive map",
                    div(class="outer",
                        ...
                        absolutePanel(id = "controls", class = "panel panel-default", fixed = TRUE,
                                      ...
                                      radioButtons("plots", "Compare To:",
                                                   c("Surrounding County", "Selected Large Bases (population > 50,000)","Selected Medium-Large Bases (population 25,000- 50,000)","Selected Medium-Small Bases (population 10,000-25,000)","Selected Small Bases (population < 10,000)")),
                                      conditionalPanel("input.color == 'base'",
                        ...
                        tags$div(id="cite",
                                 '------------------------------------Data Source:', tags$em('American Community Survey, 2015'), ' U.S. Census Bureau.')
           )
           ),
